...
function Calendar(){
  ...
  this.configure = function(configuration){
	  ...
	  this.nightsky_club_id = configuration['nightsky_club_id'];
	  this.show_event_onclick =  configuration['show_event_onclick'];
	  this.calendar_div_id = configuration['calendar_div_id'] || 'calendar';
...
"  </div>");
  ...
  this._fetch = function(){
    var source = 'http://nightsky.jpl.nasa.gov/event-calendar-xml.cfm?Club_ID=' + this.nightsky_club_id + '&Year=' + this.year + '&Month=' + this.month;
